...
suite("HuggingFaceChatModelProvider", () => {
	...
	test("convertMessages maps user/assistant text", () => {
		...
		const out = (
			provider as unknown as { convertMessages: (m: readonly vscode.LanguageModelChatMessage[]) => ConvertedMessage[] }
	...
	test("convertTools returns function tool definitions", () => {
		...
		const out = (
			provider as unknown as {
				convertTools: (o: vscode.LanguageModelChatRequestHandleOptions) => {
